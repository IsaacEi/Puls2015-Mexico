$(function(){
	...
	$.get('http://localhost:8092/Puls2015-Mexico/js/usuario.json',function(info){
...
function obtenerGeoInformacion(woeid)
{
	console.log(woeid);
var query = 'SELECT * FROM weather.forecast WHERE woeid="'+2502265+'" and u="c"';
	query = encodeURIComponent(query);
